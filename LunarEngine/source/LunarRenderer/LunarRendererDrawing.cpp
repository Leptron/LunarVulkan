...
namespace LunarRenderer {
    void LunarRenderer::createFrameBuffer() {
    ...
    void LunarRenderer::createCommandPool() {
    ...
    int LunarRenderer::drawFrame() {
        ...
        int rFrame = static_cast<int>(currentFrame);
    ...
    void LunarRenderer::createSyncObjects() {
